...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 38.657175398633285, 314.0, 183.0, 22.0 ],
					"text" : "draw.layer"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang", "", "" ],
					"patching_rect" : [ 38.657175398633285, 351.0, 305.0, 415.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 636.5, 287.5, 212.157175398633285, 287.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Dropbox/data Code/Max Msp/draw/draw.line",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
